...
typedef void (*ompt_callback_target_data_op_emi_t)(
    ...
    ompt_target_data_op_t optype, void *dev1_addr, int dev1_device_num,
    void *dev2_addr, int dev2_device_num, size_t bytes, const void *codeptr_ra);
...
typedef ompt_record_target_data_op_emi_t
    ompt_record_target_data_op_t; // deprecated
...
typedef ompt_record_target_submit_emi_t
    ompt_record_target_kernel_t; // deprecated
