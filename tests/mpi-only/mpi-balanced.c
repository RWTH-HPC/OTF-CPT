...
// CHECK: Parallel Efficiency:                {{0.99[0-9]+}}
// CHECK:   Load Balance:                     [[LB:0.99[0-9]+]]
// CHECK:   Communication Efficiency:         {{0.99[0-9]+}}
// CHECK:     Serialisation Efficiency:       1.000
// CHECK:     Transfer Efficiency:            {{0.99[0-9]+}}
// CHECK:   MPI Parallel Efficiency:          {{0.99[0-9]+}}
// CHECK:     MPI Load Balance:               [[LB]]
// CHECK:     MPI Communication Efficiency:   {{0.99[0-9]+}}
// CHECK:       MPI Serialisation Efficiency: 1.000
// CHECK:       MPI Transfer Efficiency:      {{0.99[0-9]+}}
